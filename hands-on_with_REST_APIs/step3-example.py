...
update_book_url = "http://localhost:8080/v1/books/{}".format(book_data['uuid'])  # key part of this line is the addition to the original url, UUID = universal unique identifier
